<script>
var ds            = '/';
var home_dir      = ds + "{{ (Config::get('lfm.allow_multi_user') && Session::has(Config::get('lfm.session_key'))) ? Session::get(Config::get('lfm.session_key'))[Config::get('lfm.session_field')] : '' }}";
